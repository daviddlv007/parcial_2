...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '505a33dd-0a56-4de4-81e1-e8b387c241ab' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('631cef55-64a8-49d9-b899-6bc86056dc61');
      cy.get(`[data-cy="name"]`).should('have.value', '631cef55-64a8-49d9-b899-6bc86056dc61');
